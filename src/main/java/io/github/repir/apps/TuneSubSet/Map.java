...
public class Map extends Mapper<LongWritable, Text, NullWritable, NullWritable> {
   ...
   public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
      ...
      String outputdir = configuration.getSubString("repository.idlist", "input/clueweb");
      ...
      if (space > 0) {
         ...
         if (cluewebid != null) {
            ...
            if (sf == null) {
               ...
               sf = new SubSetFile(new Datafile(io.github.repir.tools.Lib.HDTools.getFS(), filename));
