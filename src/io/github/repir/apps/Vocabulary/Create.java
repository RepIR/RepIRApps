...
public class Create {
   ...
   public static void main(String[] args) throws Exception {
      ...
      Job job = new Job(repository, "Vocabulary Builder " + repository.configuredString("repository.prefix"));
      ...
      Class clazz = ClassTools.toClass(repository.configuredString("repository.inputformat", EntityReaderInputFormat.class.getSimpleName()), EntityReaderInputFormat.class.getPackage().getName());
      Constructor c = ClassTools.getAssignableConstructor(clazz, EntityReaderInputFormat.class, Job.class);
